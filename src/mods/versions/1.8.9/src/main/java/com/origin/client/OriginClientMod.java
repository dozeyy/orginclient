...
/**
 * Origin Client for Minecraft 1.8.9 (Forge). Entry point only — all surfaces
 * register from init so a failure in any one of them can never stop the mod
 * (and the game) from loading.
 */
@Mod(modid = "originclient", name = "Origin Client", version = "@VERSION@", clientSideOnly = true, acceptedMinecraftVersions = "[1.8.9]")
