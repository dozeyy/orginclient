...
public final class MotionBlur {
	private static final ResourceLocation[] EFFECTS = {
			ResourceLocation.fromNamespaceAndPath("originclient", "shaders/post/motion_blur_1.json"),
			ResourceLocation.fromNamespaceAndPath("originclient", "shaders/post/motion_blur_2.json"),
			ResourceLocation.fromNamespaceAndPath("originclient", "shaders/post/motion_blur_3.json"),
	};
