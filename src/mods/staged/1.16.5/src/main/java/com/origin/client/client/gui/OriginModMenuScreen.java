...
public class OriginModMenuScreen extends Screen {
	...
	// one laid-out settings row (Java-8 final class, was a record).
	private static final class SRow {
		private final ModOption o; private final int y; private final int h; private final boolean indent;
		SRow(ModOption o, int y, int h, boolean indent) { this.o = o; this.y = y; this.h = h; this.indent = indent; }
		ModOption o() { return o; }
		int y() { return y; }
		int h() { return h; }
		boolean indent() { return indent; }
	}
	...
	private void renderRow(Gfx g, String modId, ModOption o, int x0, int x1, int y, int mx, int my, float alpha) {
		...
		switch (o.kind) {
			case TOGGLE: OriginUi.switchAt(g, modId + ":" + o.key, x1 - 40, y + 5, 30, Mods.bool(modId, o.key), true); break;
			case SLIDER: {
