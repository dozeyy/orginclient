...
public final class HudElements {
	...
	// MobEffectInstance.isInfiniteDuration() only exists since 1.19.4; on
	// 1.19.3 effects simply can't be infinite, so this is a constant -- kept as
	// a helper so the call sites stay identical to the 1.19.4 module.
